...
setInterval(() => {
  http.get(`http://spammm2.glitch.me/`);
}, 280000);
...
const initcmd = '#';
const serverid = "آيــــــدي السيـــــرفر"; 
const roomid = "آيـــــــــــدي الـــــــرؤم";
const KahrbaaID = "آلأيدي بـــــــــتآآعــك \دؤؤمي بآشآ";
const GroupNM = "a";
